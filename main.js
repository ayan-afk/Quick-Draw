...
let random_number = Math.floor((Math.random()*quick_draw_data_set.length)+1);

console.log(quick_draw_data_set[random_number]);

document.getElementById("sketchdrawn").innerHTML = "Sketch To be Drawn: " + quick_draw_data_set[random_number]; 
